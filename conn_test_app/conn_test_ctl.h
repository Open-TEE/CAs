...
/* TA valid commands */
#define RUN_CRYPTO_TESTS		0x34F32CBB
#define RUN_STORAGE_TESTS		0x54F32CBB
#define RUN_CRYPTO_STORAGE_TESTS	0x54B32CBB
#define RUN_NONE_TESTS			0xDDBB4422
#define RUN_TA2TA_TESTS			0xDDBB4444
