			     ...
			     TEEC_Session *session)
{
	...
	TEEC_Operation op = { 0 };
	TEEC_SharedMemory shmem_rsa_key_in = { 0 };
	TEEC_SharedMemory shmem_rsa_encrypted_aes_key_out = { 0 };
	TEEC_SharedMemory shmem_aes_encrypted_user_data = { 0 };
...
{
	struct trusted_input user_input = { 0 };
